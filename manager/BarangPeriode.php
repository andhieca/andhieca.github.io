            				...
            				<div class="card-body">
            					<div class="row">
            						<div class="col-sm-4">
										...
										<input value="" class="form-control" type="date" placeholder="Select Date" name="dateAwal" required>
									</div>
									<div class="col-sm-4">
										<label for="#">Ke Tanggal</label>
										<input value="" class="form-control" type="date" placeholder="Select Date" name="dateAkhir" required>	
									</div>
            					</div>
            					<br>
								...
								<table class="table table-striped table-hover table-bordered">
							        ...
							        <?php
									if ($dataB ==! null) {
										if(is_array($dataB) || $dataB instanceof Countable) {
											$count = count($dataB);
