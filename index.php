...
<body style="background: url(images/bgsapi.jpg) no-repeat; background-size: cover;">
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                                <img src="images/icon/hikmahjayafeed.png" alt="hikmahjayafeed" height="200px" width="200px">  
                            </a>
                        </div>
